...
cfg.num_classes = 16
cfg.cont_dim = 3
cfg.min_label = [100.0, 0.0, 0.0]  # scoping 0~90度的数据,用于数据筛选与归一化
cfg.max_label = [100.0, 60.0, 90.0]  # scoping 0~90度的数据,用于数据筛选与归一化
...
cfg.comp_is_and_fid_only = True  # 是否只计算 IS 和 FID（减少计算量）
cfg.n_fake_per_label = 50  # 每个连续标签(整数)生成多少张图像用于评估
